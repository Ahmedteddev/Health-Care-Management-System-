...
public class PatientDashboardController {
    ...
    private final PatientDashboardPanel view;
    ...
    //Updated to use the new Repository filtering method.
    private void loadPrescriptions() {
        List<Prescription> patientMeds = prescriptionRepository.getByPatientId(loggedInPatientId);
        for (Prescription prescription : patientMeds) {
